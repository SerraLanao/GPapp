...
import PacificoLocatorCallout from './PacificoLocatorCallout'
import Styles from './Styles/PacificoLocatorStyles'
...
class PacificoLocator extends React.Component {
  /* ***********************************************************
  ...
  *************************************************************/
  ...
  constructor (props) {
    ...
    *************************************************************/
    const locations = [
      { title: 'Pacifico Meetings', latitude: 40.435066, longitude: -3.697082 }
    ]
    /* ***********************************************************
    * STEP 2
    ...
    *************************************************************/
    ...
    const region = { latitude: 40.435066, longitude: -3.697082, latitudeDelta: 0.1, longitudeDelta: 0.1}
    this.state = {
      region,
      locations,
  ...
  renderMapMarkers (location) {
    ...
    * Customize the callout in ./PacificoLocatorCallout.js
    *************************************************************/

    return (
      <MapView.Marker key={location.title} coordinate={{latitude: location.latitude, longitude: location.longitude}}>
        <PacificoLocatorCallout location={location} onPress={this.calloutPress} />
      </MapView.Marker>
    )
  }
...
export default PacificoLocator
